...
import colorPallette from '../contexts/colorPallette';
...
const ListItem = ({ n, show, current, x }) => {
  return (
    <Transition
      as={'div'}
      show={show}
    ...
    >
      <div
        className={`text-[2rem] font-fira ${current[6]} ${current[5]} rounded-md py-2 px-4 flex`}
      >
        <label className="grid grid-columns-1 place-items-center">
          {x ? (
            <svg
